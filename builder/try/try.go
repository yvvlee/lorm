...
func Gt[T cmp.Ordered](dbField string, value *T) builder.Sqlizer {
	if value == nil {
		return nil
	}
...
func Gte[T cmp.Ordered](dbField string, value *T) builder.Sqlizer {
	if value == nil {
		return nil
	}
...
func Lt[T cmp.Ordered](dbField string, value *T) builder.Sqlizer {
	if value == nil {
		return nil
	}
...
func Lte[T cmp.Ordered](dbField string, value *T) builder.Sqlizer {
	if value == nil {
		return nil
	}
...
func Range[T cmp.Ordered](dbField string, min, max *T) builder.Sqlizer {
	if min == nil {
		if max == nil {
			return nil
		}
		...
		return builder.Between(dbField, *min, *max)
	}
}
