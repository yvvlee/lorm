...
var _lorm_file_testdata_user_42feee12_User_insert_columns = []string{
	"id",
	"name",
	"age",
	"created_at",
...
var _lorm_file_testdata_user_42feee12_User_insert_columns_without_auto_increment = []string{
	"name",
	"age",
	"created_at",
	"updated_at",
...
func (m *User) LormBeforeInsert(now lorm.HookTime) lorm.InsertPlan {
	...
	if plan.AutoIncrementZero {
		plan.Columns = _lorm_file_testdata_user_42feee12_User_insert_columns_without_auto_increment
	} else {
		plan.Columns = _lorm_file_testdata_user_42feee12_User_insert_columns
	}
...
func (m *User) LormAfterInsert(result lorm.InsertResult) error {
	...
	value, err := lorm.ConvertGeneratedSignedID[int](result.GeneratedID, 0, "User.ID")
	if err != nil {
		return err
	}
	m.ID = value
...
var _lorm_file_testdata_user_42feee12_User_model_descriptor = _lorm_file_testdata_user_42feee12_model_descriptor_map["User"]

func (m *User) LormModelDescriptor() *lorm.ModelDescriptor {
	return _lorm_file_testdata_user_42feee12_User_model_descriptor
}
